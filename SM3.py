m='12345674616263646162636461626364616263646162636461626364616263646162636461626364616263646162636461626364616263646162636461626364'
IV='0985166f4914b2b9172442d7da8a0600a96f30bc163138aae38dee4db0fb0e4e'
#填充函数
def filling(m):
    #消息m是一个16进制字符串
    #直接加16进制比较好
...
def expand(m,n):
    ...
    for i in range(int(len(B[n])/8)):#128/8=16
        w = B[n][i*8:(i+1)*8]
        W[i] = w
